...
FHIR_EXACT_CANONICAL: dict[str, str] = {
    ...
    "Patient-identifier[0].value":                        "NIC",
    "Patient-identifier[0].type.coding[0].code":          "NIC_type",
    ...
    "Encounter-subject.reference":                                   "encounter_patient_ref", # this will map to the patient NIC.
    ...
    "Observation-code.coding[0].display":                     "observation_name_code",
    ...
    "DiagnosticReport-code.text":                             "test_description",
    ...
    "ServiceRequest-subject.reference":                       "lab_order_patient_ref", # this will map to the patient NIC.
    ...
    # -- ChargeItem (Billing charge/service line) ------------------------------
    # "ChargeItem-id":                                         "charge_item_fhir_id",
    "ChargeItem-identifier[0].value":                        "charge_item_identifier",
    "ChargeItem-identifier[0].type.coding[0].code":          "charge_item_identifier_type",
    "ChargeItem-status":                                     "charge_item_status",
    "ChargeItem-code.coding[0].code":                        "charge_item_code",
    "ChargeItem-code.coding[0].display":                     "charge_item_name",
    "ChargeItem-code.coding[0].system":                      "charge_item_code_system",
    "ChargeItem-code.text":                                  "charge_item_description",
    "ChargeItem-subject.reference":                          "charge_item_patient_ref", # selected.
    "ChargeItem-context.reference":                          "charge_item_encounter_ref",
    "ChargeItem-occurrenceDateTime":                         "charge_item_occurrence_datetime",
    "ChargeItem-performer[0].function.coding[0].code":       "charge_item_performer_role",
    "ChargeItem-performer[0].function.coding[0].display":    "charge_item_performer_role_name",
    "ChargeItem-performer[0].actor.reference":               "charge_item_performer_ref",
    "ChargeItem-performingOrganization.reference":           "charge_item_performing_org_ref",
    "ChargeItem-requestingOrganization.reference":           "charge_item_requesting_org_ref",
    "ChargeItem-costCenter.reference":                       "charge_item_cost_center_ref",
    "ChargeItem-quantity.value":                             "charge_item_quantity",
    "ChargeItem-quantity.unit":                              "charge_item_quantity_unit",
    "ChargeItem-factorOverride":                             "charge_item_factor_override",
    "ChargeItem-priceOverride.value":                        "total_amount",
    "ChargeItem-priceOverride.currency":                     "charge_item_currency",
    "ChargeItem-overrideReason":                             "charge_item_override_reason",
    "ChargeItem-enterer.reference":                          "charge_item_enterer_ref",
    "ChargeItem-enteredDate":                                "charge_item_entered_date",
    "ChargeItem-reason[0].coding[0].code":                   "charge_item_reason_code",
    "ChargeItem-reason[0].coding[0].display":                "charge_item_reason_name",
    "ChargeItem-service[0].reference":                       "charge_item_service_ref",
    "ChargeItem-account[0].reference":                       "charge_item_account_ref",
    "ChargeItem-note[0].text":                               "charge_item_note",
    ...
    "Claim-use":                                              "claim_use",
    "Claim-patient.reference":                                "claim_patient_ref", # this will map to the patient NIC.
...
HL7_EXACT_CANONICAL: dict[str, str] = {
    ...
    # "PV1-55":   "encounter_patient_NIC", we don't need this as it's redundant with PID-3 NIC field
