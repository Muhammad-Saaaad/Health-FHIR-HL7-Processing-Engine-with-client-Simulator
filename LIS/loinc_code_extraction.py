...
LOINC_CSV_PATH = r"E:\project\Health-FHIR-HL7-Processing-Engine-with-client-Simulator\LIS\Loinc_extraction\Loinc.csv"  # Update this path to your actual CSV file location
